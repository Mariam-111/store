...
const EditProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`${import.meta.env.VITE_API}/products/${id}`, product)
      .then(() => {
  ...
  return (
    <div className="container mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto space-y-4">
        ...
        />
        {errors.ratingRate && (
          <p className="text-red-500 text-sm">{errors.ratingRate}</p>
        )}
        ...
        />
        {errors.ratingCount && (
          <p className="text-red-500 text-sm">{errors.ratingCount}</p>
        )}
